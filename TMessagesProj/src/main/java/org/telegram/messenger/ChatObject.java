...
//        }
    ...
    public static boolean isChannel(TLRPC.Chat chat) {
        // Keep structural channel detection (incl. megagroups/communities) working;
        // Microgram hides broadcast channels via isHiddenBroadcastChannel / CHANNELS_ENABLED UI gates.
